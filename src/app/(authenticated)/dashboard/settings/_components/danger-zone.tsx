...
export function DangerZone() {
  ...
  const deleteInstance = trpc.trustclaw.deleteInstance.useMutation({
    onSuccess: () => {
      showSuccessToast("EthioClaw instance deleted");
    ...
    <Card className="border-destructive/50">
      ...
      <CardContent>
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-sm font-medium">Delete EthioClaw Instance</p>
          ...
          >
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Delete EthioClaw Instance</DialogTitle>
                <DialogDescription>
